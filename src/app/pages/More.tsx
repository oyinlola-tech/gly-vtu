  ...
  const sections = [
    {
      ...
      items: [
        ...
        { icon: Shield, label: 'Session Management', path: '/security/sessions', badge: null },
        { icon: Shield, label: 'Biometric Login', path: '/security/biometric', badge: null },
        ...
        { icon: FileText, label: 'Data Export', path: '/account/data-export', badge: null },
